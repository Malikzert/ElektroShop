...
<script>
    ...
    // --- REVISED ADDRESS SELECTION HANDLER (using savedAddressSelect) ---
    if (savedAddressSelect) { // Ensure the element exists
        savedAddressSelect.addEventListener('change', function() {
            ...
            if (selectedOption.value === 'new_address') {
                ...
                // PASTIKAN BARIS-BARIS INI SESUAI DENGAN KOREKSI DI BAWAH:
                namaPenerimaInput.value = selectedOption.dataset.nama_penerima;
                noTeleponInput.value = selectedOption.dataset.no_telepon;
                alamatLengkapInput.value = selectedOption.dataset.alamat_lengkap;
                ...
                kodePosInput.value = selectedOption.dataset.kode_pos;
                provinsiInput.value = selectedOption.dataset.provinsi;
            }
        });
    }
// --- END REVISED ADDRESS SELECTION HANDLER ---
